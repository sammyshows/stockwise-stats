...
const handler: Handler = async (event, context) => {
  ...
  const userStats = async () => await client`
    ...
    WHERE user_id NOT IN ('81845c27-18fb-4a7b-8fb6-9046c949deb7', '9e5a2c95-4244-4a2a-87bb-3cdb377c67e7', '11fd76ee-7cc5-4adb-bac0-3aa7051515ae', '79eb1e98-9c2f-4133-84cc-584ed8cebef2');
  `
