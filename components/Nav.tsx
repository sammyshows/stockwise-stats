...
export default function Nav() {
  ...
  return (
    <Navbar fluid={true} rounded={true} className="border-b border-slate-600 bg-slate-800">
      <Navbar.Brand to="/">
      ...
      <Navbar.Collapse>
        <Navbar.Link href="/">
          <span className={ routePath === '/' ? 'text-emerald-400 underline underline-offset-4' : 'text-slate-300' }>Overview</span>
        </Navbar.Link>
        ...
        <Navbar.Link href="/stats">
          <span className={ routePath === '/stats' ? 'text-emerald-400 underline underline-offset-4' : 'text-slate-300' }>Stats</span>
        </Navbar.Link>
        <Navbar.Link href="/logs">
          <span className={ `pr-10 ${routePath === '/logs' ? 'text-emerald-400 underline underline-offset-4' : 'text-slate-300' }` }>Logs</span>
        </Navbar.Link>
      </Navbar.Collapse>
    </Navbar>
  )
